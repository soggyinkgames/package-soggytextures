...
namespace com.soggyinkgames.PackageSoggyShaders.RendererFeatures
{
    ...
    public partial class RF_FullScreenPassRendererFeature : ScriptableRendererFeature
    {
        /// <summary>
        ...
        internal class FullScreenRenderPass : ScriptableRenderPass
        {
            ...
            private static void ExecuteMainPass(RasterCommandBuffer cmd, RTHandle sourceTexture, Material material, int passIndex)
            {
                ...
                if (sourceTexture != null)
                    s_SharedPropertyBlock.SetTexture(m_BlitTextureID, sourceTexture);
